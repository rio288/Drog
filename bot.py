...
TOKEN = os.getenv("TOKEN")  # حط توكن بوتك هنا أو في متغيرات البيئة
ADMINS = [8145101051]
...
async def get_stream_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if use_filter or is_pro:
        vf = (
            "drawtext=text='Premium User':"
            "fontcolor=white:fontsize=24:x=10:y=10:shadowcolor=black:shadowx=2:shadowy=2,"
            "hue=s=0.9,"
    ...
    cmd = [
        ...
        "-c:v", "libx264",
        "-preset", "veryfast",
        "-maxrate", "3500k" if is_pro else "1500k",
        "-bufsize", "7000k" if is_pro else "3000k",
        "-g", "50",
        "-r", "25",
        "-pix_fmt", "yuv420p",
        "-af", af,
