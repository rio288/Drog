...
# إعدادات عامة
TOKEN = os.getenv("TOKEN")  # يجب تعيين متغير البيئة TOKEN مسبقاً أو تغييره هنا
ADMINS = [8145101051]  # ضع معرف المشرفين هنا
...
async def get_stream_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # إعداد الفلاتر والجودة حسب الاشتراك
    vf = "null"
    af = "anull"
    if use_filter or is_pro:
        vf = "hue=s=0.9,eq=contrast=1.05:brightness=0.02:saturation=1.02,drawbox=x=0:y=0:w=iw:h=60:color=black@0.3:t=fill"
