...
async def get_stream_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_pro:
        ...
        cmd = [
            ...
            "-bufsize", "7000k", "-g", "50", "-r", "30", "-pix_fmt", "yuv420p",
            "-af", af,
    ...
    if is_pro:
        await update.message.reply_text("📡 جاري بدء البث بجودة عالية (HD) للمشتركين ✅")
    else:
        await update.message.reply_text("📡 جاري بدء البث بجودة قياسية (SD). اشترك للحصول على جودة أعلى 💠")
