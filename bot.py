...
async def get_stream_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # هنا التعديلات على ffmpeg لتجنب حظر الكوبيرايت:
    # - تسريع الفيديو 2%
    # - رفع pitch الصوت 10%
    # - إضافة تمويه خفيف على الفيديو
    ...
    if is_pro:
        ...
        if broadcast_type == "live_ig":
            # ضبط فيديو انستاغرام - عمودي ودقة 1080x1920 مع التعديلات
            cmd = [
                "ffmpeg", "-re", "-i", link,
            ...
            # ضبط فيديو فيسبوك بدقة أقل للمستخدم المجاني
            cmd = [
                "ffmpeg", "-re", "-i", link,
                "-vf", f"scale=854:-2,{vf}",
    ...
    # تشغيل ffmpeg في thread منفصل حتى لا يغلق البوت
