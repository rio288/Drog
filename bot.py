...
TOKEN = os.getenv("TOKEN")  # ضع التوكن هنا أو في متغير بيئي
ADMINS = [8145101051]  # استبدل بالـ user_id الخاص بك كمشرف
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # إذا المستخدم ينتظر إدخال بيانات الاشتراك (للمشرف)
    ...
    # إذا المستخدم في حالة حوار، لا نرسل رسالة عامة
    ...
    if text == "🎬 تجهيز البث":
        ...
        context.user_data["conversation_state"] = "SELECT_TYPE"
        return SELECT_TYPE

    if text == "⏹ إيقاف بث":
        await update.message.reply_text("أرسل اسم البث الذي تريد إيقافه:")
        context.user_data["conversation_state"] = "STOP_STREAM_NAME"
